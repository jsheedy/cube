...
int main()
{
    ...
    float cubeVertices[] = {
         0.8f,  0.8f, 0.8f, 1.0f, 0.2f, 0.5f, // top right
         0.8f, -0.8f, 0.8f, 0.0f, 0.8f, 0.5f, // bottom right
        -0.8f, -0.8f, 0.8f, 1.0f, 0.2f, 0.9f, // bottom left
        -0.8f,  0.8f, 0.8f,  0.2f, 0.5f, 0.5f, // top left

         0.8f,  0.8f, 0.8f, 1.0f, 0.1f, 0.1f, // top right
         0.8f, -0.8f, 0.8f, 0.0f, 0.0f, 0.0f, // bottom right
        -0.8f, -0.8f, 0.8f, 1.0f, 1.0f, 1.0f, // bottom left
        -0.8f,  0.8f, 0.8f,  0.0f, 0.8f, 0.1f // top left
    };
